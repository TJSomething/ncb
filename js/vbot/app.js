...
var Stats = require('exports?Stats!threejs-stats/Stats');
var utils = require('./utils');
var Robot = require('./robot');
var physics = require('./physics');
var controller = require('./controller');
var KMZLoader = require('../KMZLoader');
var makeHUD = require('./hud');
...
function calcSize() {
    var width = window.innerWidth,
        height = window.innerHeight - $('div.navbar-collapse').outerHeight(),
        aspect = width / height;
...
function resizeViewportContainer() {
    if (app.hasOwnProperty('container')) {
        var style = app.container.style,
            toolbarHeight = $('div.navbar-collapse').outerHeight();
