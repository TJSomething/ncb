...
define(['vbot/three', 'vbot/physics', 'vbot/motion'],
function (THREE, physics, motion) {
    ...
    var hasArms = {
        ...
        rotateArmTowards: function (arm, targetVector, amount, inRadians,
            ...
            rotMatrix = new THREE.Matrix4().set(
                b[0].x, b[1].x, b[2].x, 0,
                b[0].y, b[1].y, b[2].y, 0,
                b[0].z, b[1].z, b[2].z, 0,
                0,   0,    0,   1
    ...
    var Robot = (function () {
        ...
        function Steve(obj) {
            ...
            loader.load('assets/3d/steve.js', function (geometry, materials) {
        ...
        function Carl(obj) {
            var loader = new THREE.JSONLoader(true);
            loader.load('assets/3d/carl.js', function (geometry, materials) {
                var i, camHeight, near,
        ...
        function Mouse(obj) {
            ...
            loader.load('assets/3d/mouse.js', function (robotObj) {
                var camHeight, near;
