define(['vbot/three', 'numericjs', 'underscore'],
function (THREE, numeric, _) {
    ...
    collision.OBB = function (center, bases, halfExtents, parent) {
        ...
        var rotMatrix =
            new THREE.Matrix4().set(bases[0].x, bases[1].x, bases[2].x, 0,
    ...
    collision.OBB.prototype = {
        ...
        makeMatrix: function () {
            ...
            return new THREE.Matrix4().set(sc[0] * E[0][0], sc[1] * E[0][1], sc[2] * E[0][2], p.x,
