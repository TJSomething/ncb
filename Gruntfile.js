  ...
  grunt.initConfig({
      ...
      debug: {
        files: [
          ...
          },
          {
            expand: true,
            flatten: true,
            src: ['tmp/ncbjs/compiled.js'],
            dest: 'build/static/assets/js'
          },
          {
            expand: true,
            flatten: true,
            src: ['tmp/ncbjs/vbot_worker.js'],
            dest: 'build/static/assets/js'
          },
          {
            expand: true,
            flatten: true,
            src: ['js/vbot/sample_script.js'],
            dest: 'build/static/assets/js'
          },
          {
            expand: true,
    ...
    concat: {
      ...
      vbotWorker: {
        src: [
          'tmp/vendorjs/underscore.js',
          'tmp/vendorjs/esprima.js',
          'js/vbot/worker.js'
        ],
        dest: 'tmp/ncbjs/vbot_worker.js'
      }
    },
    uglify: {
      vendorjs: {
      ...
      ncbjs: {
        files: {
          ...
          'build/static/assets/js/vbot_worker.js': 'tmp/ncbjs/vbot_worker.js'
        }
      }
    },
    cssmin: {
